...
<body>
<center>
<form  method="post" action="markprocess.jsp">
  ...
  <div class="form-group" style="width:50%">
    ...
    <input type="password" class="form-control" id="exampleInputPassword1"  name="last_name">
  </div>
  <div class="form-group" style="width:50%">
  ...
  <div class="form-group" style="width:50%">
    ...
    <input type="password" class="form-control" id="exampleInputPassword1"  name="marks">
  </div>
